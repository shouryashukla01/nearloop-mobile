...
export function ProfileScreen() {
  ...
  return (
    <Screen>
      <Text style={{ color: theme.colors.coral, fontWeight: "900", letterSpacing: 1 }}>PROFILE</Text>
      <Text style={{ fontSize: 36, lineHeight: 40, fontWeight: "900" }}>Your social signal.</Text>
      <Card style={{ gap: 8 }}>
