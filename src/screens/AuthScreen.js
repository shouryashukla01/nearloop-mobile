  ...
  return (
    <Screen>
      <View style={{ marginTop: 28 }}>
        ...
        <Text style={{ marginTop: 8, fontSize: 44, lineHeight: 48, fontWeight: "900", color: theme.colors.ink }}>
          Find plans before they blow up.
        </Text>
        <Text style={{ marginTop: 12, fontSize: 17, lineHeight: 27, color: theme.colors.muted }}>
      ...
      <View style={{ flexDirection: "row", gap: 12 }}>
        {[
          ...
          <Image key={uri} source={{ uri }} style={{ flex: 1, height: index === 1 ? 150 : 120, borderRadius: 12, marginTop: index === 1 ? 24 : 0 }} />
        ))}
      </View>
