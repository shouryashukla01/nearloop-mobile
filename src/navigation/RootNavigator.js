...
function Tabs({ navigation }) {
  ...
  const systemBottom = Platform.OS === "android" ? Math.max(insets.bottom, 30) : insets.bottom;
  const tabBarHeight = 78 + systemBottom;
      ...
      <Tab.Navigator
        screenOptions={({ route }) => ({
          ...
          tabBarStyle: {
            height: tabBarHeight,
            paddingTop: 7,
            paddingBottom: Math.max(systemBottom, 18),
